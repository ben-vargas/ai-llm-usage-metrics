...
- **Up to ~20x faster** than `ccusage-codex` in cached environments.
- **3.4x faster** raw cold-start parsing.
- **Sub-second reporting** (0.79s vs 14.04s) for standard monthly audits.
