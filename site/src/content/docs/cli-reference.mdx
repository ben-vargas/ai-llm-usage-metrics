...
Generated from CLI version `0.4.1` via `scripts/generate-cli-reference.mjs`.
...
| --- | --- | --- | --- |
| `--candidate-model` | - | `<name>` | Candidate model for counterfactual pricing (repeatable or comma-separated) (default: []) (optimize only) |
...
| `--share` | - | - | Write a share SVG image to the current directory |
