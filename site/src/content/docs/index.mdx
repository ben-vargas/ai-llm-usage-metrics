...
Welcome to the `llm-usage-metrics` documentation. This high-performance CLI tool provides deep visibility into your local AI development costs by aggregating usage across pi, codex, and OpenCode sessions.
...
<CardGrid>
  ...
  <LinkCard
    title="Data Sources"
    description="Technical details on pi, codex, and OpenCode adapters."
...
- **Universal Parsing**: Autonomously discovers and parses `.pi`, `.codex`, and OpenCode session data.
