...
describe('renderMarkdownTable', () => {
  it('renders the same row semantics as the terminal renderer in markdown format', () => {
    ...
    expect(rendered).toMatchInlineSnapshot(`
      ...
      | 2026-02-10 | combined | gpt-4.1, gpt-5-codex | 2,000 |    500 |       120 |        100 |           0 |        2,720 |      $2.75 |
      | ALL        | TOTAL    | gpt-4.1, gpt-5-codex | 2,000 |    500 |       120 |        100 |           0 |        2,720 |      $2.75 |"
    `);
  });
});
